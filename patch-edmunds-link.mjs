...
const linkFunction = 'function Ew(e,t,n){const r=l=>String(l||"").trim().toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"");return `https://www.edmunds.com/${r(e)}/${r(n)}/${encodeURIComponent(t)}/`}';
...
console.log("Added Edmunds links to the interactive and printable warranty sections.");
